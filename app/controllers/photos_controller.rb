...
#   end
  ...
  def create
    ...
    respond_to do |format|
      if @photo.save
        format.html { redirect_to gallery_path, notice: 'Photo was successfully created.' }
  ...
  def destroy
    @photo.destroy
    respond_to do |format|
      format.html { redirect_to gallery_path, notice: 'Photo was successfully destroyed.' }
